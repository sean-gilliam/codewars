/*
Difficulty: 5kyu 
URL: https://www.codewars.com/kata/54746b7ab2bc2868a0000acf
Description: NOTE: This kata requires a decent knowledge of Regular Expressions. As such, it's best to learn about it before tackling this kata. Some good places to start are: the MDN pages, and Regular-Expressions.info.
...
public class Mod
{
    public static Regex MOD4 = new Regex(@"\[[+-]?0*(\d*([13579]{1}[26]{1}|[02468]{1}[048]{1})|0|4|8)\]");
}
